...
class Zombie:
  ...
  def increase_plague_level(cls):
    plague_level = random.randint(0, 2)
    Zombie.plague_level += plague_level
  ...
  def encounter(self):
    ...
    if outrun:
      ...
      return 'You survived but you are now a zombie. Raawwrghh!'
    else:
      return 'You died.'
  ...
  def fight(self):
    """ Represents you trying to kill this particular zombie.
    Uses 'Zombie.max_strength' to generate a random number that represents how fast you manage to kill.
    """
